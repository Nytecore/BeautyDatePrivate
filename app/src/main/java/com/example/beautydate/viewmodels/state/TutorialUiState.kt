...
import com.example.beautydate.data.models.TutorialPreferences
...
data class TutorialUiState(
    ...
    val personalizedRecommendations: List<TutorialData>
        get() = recommendedTutorials.ifEmpty {
            ...
            allTutorials.filter { 
                !it.isCompleted && it.difficulty == com.example.beautydate.data.models.TutorialDifficulty.BEGINNER 
            }.take(3)
        }
