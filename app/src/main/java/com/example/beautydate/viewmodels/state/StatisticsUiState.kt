...
data class StatisticsUiState(
     ...
     */
    val financialStats: com.example.beautydate.data.models.FinancialStatistics?
        get() = statistics?.financialStats
    
    /**
     * Returns customer statistics if available
     */
    val customerStats: com.example.beautydate.data.models.CustomerStatistics?
        get() = statistics?.customerStats
    
    /**
     * Returns appointment statistics if available
     */
    val appointmentStats: com.example.beautydate.data.models.AppointmentStatistics?
        get() = statistics?.appointmentStats
    
    /**
     * Returns employee statistics if available
     */
    val employeeStats: com.example.beautydate.data.models.EmployeeStatistics?
        get() = statistics?.employeeStats
    
    /**
     * Returns service statistics if available
     */
    val serviceStats: com.example.beautydate.data.models.ServiceStatistics?
