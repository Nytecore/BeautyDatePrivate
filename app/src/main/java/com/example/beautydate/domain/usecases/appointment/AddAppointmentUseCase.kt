package com.example.beautydate.domain.usecases.appointment
...
class AddAppointmentUseCase @Inject constructor(
     ...
     * Memory efficient: targeted conflict checking
     */
    private suspend fun checkTimeConflicts(appointment: Appointment): Result<Unit> {
        ...
        val conflictingAppointment = existingAppointments.find { existing ->
            ...
            existing.status.name != "CANCELLED" &&
            existing.id != appointment.id // Exclude self when updating
        }
        
        if (conflictingAppointment != null) {
            return Result.failure(IllegalArgumentException("Bu saatte zaten randevu bulunmaktadır"))
        }
        ...
        workingHoursResult.fold(
            onSuccess = { workingHours ->
                ...
                val dayOfWeek = when (appointmentDate.dayOfWeek) {
                    java.time.DayOfWeek.MONDAY -> com.example.beautydate.data.models.DayOfWeek.MONDAY
                    java.time.DayOfWeek.TUESDAY -> com.example.beautydate.data.models.DayOfWeek.TUESDAY
                    java.time.DayOfWeek.WEDNESDAY -> com.example.beautydate.data.models.DayOfWeek.WEDNESDAY
                    java.time.DayOfWeek.THURSDAY -> com.example.beautydate.data.models.DayOfWeek.THURSDAY
                    java.time.DayOfWeek.FRIDAY -> com.example.beautydate.data.models.DayOfWeek.FRIDAY
                    java.time.DayOfWeek.SATURDAY -> com.example.beautydate.data.models.DayOfWeek.SATURDAY
                    java.time.DayOfWeek.SUNDAY -> com.example.beautydate.data.models.DayOfWeek.SUNDAY
                }
    ...
    private suspend fun validateWorkingHours(appointment: Appointment): Boolean {
        return try {
            ...
            val dayOfWeek = com.example.beautydate.data.models.DayOfWeek.MONDAY // Placeholder
            
            // Get working hours for that day
            val dayHours = when (dayOfWeek) {
                com.example.beautydate.data.models.DayOfWeek.MONDAY -> workingHours.monday
                com.example.beautydate.data.models.DayOfWeek.TUESDAY -> workingHours.tuesday
                com.example.beautydate.data.models.DayOfWeek.WEDNESDAY -> workingHours.wednesday
                com.example.beautydate.data.models.DayOfWeek.THURSDAY -> workingHours.thursday
                com.example.beautydate.data.models.DayOfWeek.FRIDAY -> workingHours.friday
                com.example.beautydate.data.models.DayOfWeek.SATURDAY -> workingHours.saturday
                com.example.beautydate.data.models.DayOfWeek.SUNDAY -> workingHours.sunday
            }
