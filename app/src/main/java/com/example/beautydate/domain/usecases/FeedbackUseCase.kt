package com.example.beautydate.domain.usecases

import com.example.beautydate.data.repository.FeedbackRepository
import com.example.beautydate.domain.models.FeedbackData
...
class FeedbackUseCase @Inject constructor(
     ...
     */
    fun validateFeedbackInput(subject: String, message: String): com.example.beautydate.domain.models.ValidationResult {
        val feedbackData = FeedbackData(
            subject = subject.trim(),
            message = message.trim()
        )
