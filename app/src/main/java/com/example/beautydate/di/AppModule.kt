...
import com.example.beautydate.data.local.ThemePreferences
import com.example.beautydate.data.local.CustomerDatabase
...
import com.example.beautydate.data.local.CustomerNoteDao
import com.example.beautydate.data.local.dao.PaymentDao
import com.example.beautydate.data.local.dao.TransactionDao
...
object AppModule {
     ...
     */
    @Provides
    fun provideAppointmentDao(database: CustomerDatabase): com.example.beautydate.data.local.dao.AppointmentDao {
     ...
     */
    @Provides
    fun provideWorkingHoursDao(database: CustomerDatabase): com.example.beautydate.data.local.dao.WorkingHoursDao {
    ...
    @Provides
    @Singleton
    fun provideTutorialPreferences(@ApplicationContext context: Context): com.example.beautydate.data.local.TutorialPreferences {
        return com.example.beautydate.data.local.TutorialPreferences(context)
    }
