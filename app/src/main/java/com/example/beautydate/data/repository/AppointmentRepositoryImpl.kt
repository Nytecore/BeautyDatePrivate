...
import com.example.beautydate.data.local.AppointmentEntity
...
import com.example.beautydate.data.remote.models.AppointmentFirestore
        ...
        return try {
            ...
            val remoteEntities = remoteAppointments.documents.mapNotNull { doc ->
                doc.toObject(AppointmentFirestore::class.java)?.let { firestore ->
                    AppointmentEntity.fromDomainModel(firestore.toDomainModel(), needsSync = false)
                }
            }
