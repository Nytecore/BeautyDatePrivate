    ...
    companion object {
        ...
        private fun parseSkillsFromJson(json: String): List<String> {
            return try {
                ...
                println("Debug: Failed to parse skills JSON: $json, error: ${e.message}")
                emptyList()
            }
        }
                    ...
                    json.removeSurrounding("[", "]")
                        ...
                        .mapNotNull { permissionName ->
                            try {
                                ...
                                println("Debug: Unknown permission: $permissionName")
                                null
                            }
                        }
                }
            } catch (e: Exception) {
                println("Debug: Failed to parse permissions JSON: $json, error: ${e.message}")
                emptyList()
            }
        }
    }
