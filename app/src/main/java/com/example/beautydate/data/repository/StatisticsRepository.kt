...
interface StatisticsRepository {
     ...
     */
    suspend fun getFinancialStatistics(businessId: String, period: StatisticsPeriod = StatisticsPeriod.ALL_TIME): com.example.beautydate.data.models.FinancialStatistics
    
    /**
     * Gets customer statistics only
     */
    suspend fun getCustomerStatistics(businessId: String, period: StatisticsPeriod = StatisticsPeriod.ALL_TIME): com.example.beautydate.data.models.CustomerStatistics
    
    /**
     * Gets appointment statistics only
     */
    suspend fun getAppointmentStatistics(businessId: String, period: StatisticsPeriod = StatisticsPeriod.ALL_TIME): com.example.beautydate.data.models.AppointmentStatistics
    
    /**
     * Gets employee statistics only  
     */
    suspend fun getEmployeeStatistics(businessId: String, period: StatisticsPeriod = StatisticsPeriod.ALL_TIME): com.example.beautydate.data.models.EmployeeStatistics
    
    /**
     * Gets service statistics only
     */
    suspend fun getServiceStatistics(businessId: String, period: StatisticsPeriod = StatisticsPeriod.ALL_TIME): com.example.beautydate.data.models.ServiceStatistics
