...
import com.example.beautydate.data.local.TutorialPreferences
...
class TutorialRepositoryImpl @Inject constructor(
    ...
    override fun getTutorialPreferences(): Flow<com.example.beautydate.data.models.TutorialPreferences> {
        return flowOf(
            com.example.beautydate.data.models.TutorialPreferences(
                ...
                tutorialSpeed = com.example.beautydate.data.models.TutorialSpeed.NORMAL
            )
        )
    }
    
    override suspend fun updateTutorialPreferences(preferences: com.example.beautydate.data.models.TutorialPreferences): Result<Unit> {
        return try {
