...
interface TutorialRepository {
     ...
     */
    fun getTutorialPreferences(): Flow<com.example.beautydate.data.models.TutorialPreferences>
    
    /**
     * Updates tutorial preferences
     */
    suspend fun updateTutorialPreferences(preferences: com.example.beautydate.data.models.TutorialPreferences): Result<Unit>
