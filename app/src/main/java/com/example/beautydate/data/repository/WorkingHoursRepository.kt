...
interface WorkingHoursRepository {
    ...
    suspend fun updateDayHours(
        dayOfWeek: com.example.beautydate.data.models.DayOfWeek, 
        dayHours: com.example.beautydate.data.models.DayHours
    ): Result<WorkingHours>
     ...
     */
    suspend fun getNextOpenTime(): com.example.beautydate.data.models.DayHours?
